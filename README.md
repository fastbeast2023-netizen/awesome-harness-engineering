...
- [Citadel](https://github.com/SethGammon/Citadel) - An agent orchestration harness for Claude Code and OpenAI Codex that coordinates parallel agents in isolated worktrees, persists memory and campaign state across sessions, and routes intent to the cheapest execution path with tiered classification, safety hooks, and cost tracking.
